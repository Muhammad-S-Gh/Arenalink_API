...
export class SchedulesService {
    ...
    private minutesToTime(mins: number): string {
        ...
        // .padStart(2, '0') makes sure it’s at least 2 characters long, padding with leading '0' if needed.
    }
    ...
    async createSpecificHoliday(facilityId: number, dto: SpecificHolidayDto) {
        ...
        console.log(`💥💥💥💥💥💥💥💥💥💥${dto.date}`); // Mon Aug 25 2025 03:00:00 GMT+0300 (GMT+03:00)
        console.log(`💥💥💥💥💥💥💥💥💥💥${dto.date.toISOString()}`); // 2025-08-25T00:00:00.000Z
        console.log(`💥💥💥💥💥💥💥💥💥💥${isoDate}`); // 2025-08-25
        console.log(`💥💥💥💥💥💥💥💥💥💥${dateOnly}`); // Mon Aug 25 2025 03:00:00 GMT+0300 (GMT+03:00)
        ...
        // this is redundant since if the day is day-off then it is not an available day and the first condition will always get executed
    ...
    async getSlots(facilityId: number, availabilityId: number): Promise<AvailabilityDetailDto> {
        ...
        const qb = this.availabilityRepository
            ...
            }) // relation Join / alias (new table name) /
        ...
        // 2) compute facility capacity (once)
        const facility = await this.facilityService.findByIdForReservation(facilityId);
