...
export class OwnerController {
    ...
    // get facility pending reservations
    ...
    // change reservation status from pending to ready or rejected
    ...
    async ownerRefund(
        ...
        // you may validate facilityId matches the payment->facility inside the service too
    ...
    // Get all facilities owned by the logged-in owner
    @Roles(UserRole.OWNER)
    @UseGuards(JwtGuard, RolesGuard, ValidOwnerGuard, IsVerifiedGuard)
    @Get('facilities')
    ...
    //         return this.updateFacilitiesService.updateFacility(id, body as UpdateFacilityDto, user);
    //     }
}
