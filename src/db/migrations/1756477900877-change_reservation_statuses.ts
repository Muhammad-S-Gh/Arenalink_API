...
export class ChangeReservationStatuses1756477900877 implements MigrationInterface {
    name = 'ChangeReservationStatuses1756477900877'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."reservations_status_enum" RENAME TO "reservations_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."reservations_status_enum" AS ENUM('pending', 'confirmed', 'declined', 'blocked', 'ready', 'rejected')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."reservations_status_enum_old" AS ENUM('pending', 'confirmed', 'declined', 'blocked')`);
        await queryRunner.query(`ALTER TABLE "reservations" ALTER COLUMN "status" DROP DEFAULT`);
