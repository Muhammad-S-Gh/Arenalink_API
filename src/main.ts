...
async function bootstrap() {
    ...
    // somewhere in your module bootstrap for template usage
    ...
    const frontendUrl = configService.get('FRONTEND_URL'); // if set, will allow only this origin

    app.enableCors({
        origin: true, // reflect request origin (works for any origin)
        credentials: true,
