...
import { HomeController } from './modules/categories/home.controller';
import { FavoritesModule } from './modules/favorites/favorites.module';
import * as Joi from 'joi';
// import { MultipartMiddleware } from './shared/middlewares/multipart.middleware';
dotenv.config();
...
export class AppModule {
    ...
    //         .exclude({ path: 'payment/webhook/stripe', method: RequestMethod.POST })
